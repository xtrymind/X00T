...
#if WAKEUP_GESTURE
#define GESTURE_EVENT_C 		KEY_C
#define GESTURE_EVENT_E 		KEY_E
#define GESTURE_EVENT_S 		KEY_S
#define GESTURE_EVENT_V 		KEY_V
#define GESTURE_EVENT_W 		KEY_W
#define GESTURE_EVENT_Z 		KEY_Z
#define GESTURE_EVENT_SWIPE_UP		KEY_UP
